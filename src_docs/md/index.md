...
Each row is one model on one engine, asked which of five tasks a FontLab user wants, over 67 queries in 30 languages. Click a column header to sort. [Chapter 6](06-results.md) has all 208 rows.

--8<-- "tables/top.html"

## What is in this book

- **Concepts.** [Chapter 1](01-deciding.md) says what a System One decision is. [Chapter 2](02-decisions.md) covers what you ask and what you get back. [Chapter 3](03-engines.md) shows how five stacks read an answer out of a model. [Chapter 4](04-models.md) covers dedicated, fine-tuned and vanilla models.
